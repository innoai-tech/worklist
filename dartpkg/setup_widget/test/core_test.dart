...
class UncontrolledCustomText extends SetupWidget<UncontrolledCustomText> {
  final String text;
  ...
  setup(sc) {
    return () {
      return Text("value_from_prop__${sc.widget.text}");
    };
  }
}

class ControlledCustomText extends SetupWidget<ControlledCustomText> {
  final String text;
  ...
  @override
  setup(c) {
    final text = ref(c.widget.text);

    watch(() => c.widget.text, (value, prev) {
      text.value = value;
    });
